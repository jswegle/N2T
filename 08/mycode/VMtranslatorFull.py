...
class CodeWriter(object):
    ...
    def __init__(self, asmfile):
        ...
        self.writeInit()
        self.write('//Sys init below')
        self.writeCall('Sys.init', '0')
        self.write('//Sys.init above')
...
#####
    ...
    def writeCall(self, functionName, numArgs):
        self.write('//WRITECALL')
        self.write('@returnTo'+str(self.returnAddressIndex))
        self.write('D=A')
        ...
        self.write('(returnTo'+str(self.returnAddressIndex)+')')
        self.returnAddressIndex = self.returnAddressIndex+1

    def writeReturn(self):
        self.write('//WRITERETURN')
        ##Frame = LCL
        ## Frame = R13
        self.write('@LCL')
        self.write('D=M')
    ...
    def writeFunction(self, functionName, numLocals):
        ...
        self.currLabelPrefix = functionName
        self.write('('+functionName+')')
        numLcls = int(numLocals)
        while numLcls > 0:
            ##print(functionName + 'local V left: '+ numLocals )
            self.write('@0')
            self.write('D=A')
            self.fromDtoStackandInc()
            numLcls = numLcls-1
